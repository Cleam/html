$(document).ready(function(){
	...
	localStorage.setItem("backgroundimg",skin);
	$('[name=body]').attr('id', skin);
//	$(window.frames["contentarea"].document).find("body:eq(0)").attr('id', skin);
...
$(window).load(function(){
	...
	//从localstorage里面读取背景图
	var skin = localStorage.getItem("backgroundimg");
	if(skin!=null){
		$('[name=body]').attr('id', skin);
	}
	else {
		$('[name=body]').attr('id', "skin-blur-violate");
	}
