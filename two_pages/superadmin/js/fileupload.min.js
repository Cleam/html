     		        ...
     		        .then(function (rst) {
     		           ...
     		           var r = new FileReader,
     	                ...
     	                r.onload = function(ee) {
     	                	...
     	                	$.ajax({
     	               		type : "POST",
     	               		url : basePath + "/editpage01/imageupdate.do",
     	               		data : {
     	               			"imgstr" : base64str
     	               		},
     	               		dataType : "json",
     	               		...
     	               		success : function(data) {
     	               			...
     	               			if (data.state == false) {
     	               			 ...
     	               			 i.html('<img src="' + base64str + '" ' + (i.css("max-height") != "none" ? 'style="max-height: ' + i.css("max-height") + ';"': "") + "localimage='"+data.data+"' />"),
...
//                s = tmpthis.$element;
//                r.onload = function(ee) {
//                    i.html('<img src="' + ee.target.result + '" ' + (i.css("max-height") != "none" ? 'style="max-height: ' + i.css("max-height") + ';"': "") + " />"),
//                    s.addClass("fileupload-exists").removeClass("fileupload-new")
//                },
//                r.readAsDataURL(n)
